...
const FITS := {
	"res://src/world/platforms/platform.tscn": Rect2(430, 56, 677, 260),
	"res://src/world/platforms/blink_platform.tscn": Rect2(430, 56, 677, 260),
	"res://src/world/platforms/moving_platform.tscn": Rect2(190, 383, 1153, 256),
	"res://src/world/platforms/falling_platform.tscn": Rect2(26, 701, 1484, 243),
}
