...
func _ready() -> void:
	...
	assert(Guardian.STEP_SOUNDS.size() == 5)
	assert(Guardian.WINDUP_SOUNDS.size() == 3)
	assert(Guardian.STOMP_SOUNDS.size() == 5)
	assert(Guardian.VOICE_GROWLS.size() == 3)
	assert(Guardian.VOICE_SHOUTS.size() == 3)
	assert(Guardian.VOICE_HURTS.size() == 4)
	assert(Guardian.VOICE_ROARS.size() == 2)
