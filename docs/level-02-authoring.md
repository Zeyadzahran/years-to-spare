...
- The street hole (`1408–1920`, 512 px) cannot be jumped on a fresh run, not
  ...
  he is standing - the lesson does not age him. `Tutorial/Dare` at
  `(1664, 520)` hangs `I DARE YOU / JUMP IT` in the air over the hole: it
  surfaces as he nears the lip and is gone for the rest of the run once the
  lesson has been given. Once the rewind has stood him back on the street, he and
